        ...
        <div className="relative w-full flex justify-center lg:justify-end">
          <div className="relative w-full max-w-[460px]">
            ...
            >
              ...
              <div className="relative h-[190px] bg-gray-200">
                {imgErr ? (
              ...
              <div className="px-5 py-3" style={{ padding: "14px 20px" }}>
                <h3 className="font-bold text-[#111]" style={{ fontSize: 17 }}>강남 OO 한의원</h3>
                <p className="text-sm mt-0.5">
                  <span className="text-[#FFD600]">★★★★★ 4.9</span> <span className="text-[#666]">(리뷰 1,247개)</span>
                </p>
                <div className="border-t border-[#f0f0f0] pt-2.5 mt-2.5 grid grid-cols-3 text-center">
                  <div>
                    <p className="font-extrabold text-[#111]" style={{ fontSize: 18 }}>4,100회</p>
                    <p className="text-[11px] text-[#888]">월 클릭</p>
                  </div>
                  <div>
                    <p className="font-extrabold text-[#111]" style={{ fontSize: 18 }}>94건</p>
                    <p className="text-[11px] text-[#888]">전화문의</p>
                  </div>
                  <div>
                    <p className="font-extrabold text-[#111]" style={{ fontSize: 18 }}>1,832회</p>
