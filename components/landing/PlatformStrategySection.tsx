  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="flex items-center gap-3">
        <div className="flex-1 h-7 rounded-lg bg-gray-700 overflow-hidden flex">
          <motion.div
            initial={{ width: 0 }}
        ...
        <div className="flex items-center gap-2 shrink-0 text-sm">
          ...
          {increase > 0 && (
            <span className="px-1.5 py-0.5 rounded text-xs font-bold text-white" style={{ backgroundColor: RESULT_GREEN }}>
              ▲{increase}%
            </span>
          )}
        </div>
...
export function PlatformStrategySection() {
  ...
  return (
    <section className="relative w-full py-16 sm:py-24 lg:py-28 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: BG }}>
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16">
          <span className="inline-block px-3 py-1 rounded-full border text-xs font-semibold mb-4" style={{ borderColor: ACCENT, color: ACCENT }}>PROVEN RESULTS</span>
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4 break-keep">단순 노출 X, 매출이 터지는 실행입니다</h2>
          <p className="text-slate-400 text-sm sm:text-base max-w-2xl mx-auto">블로그 하나, 리뷰 하나도 전략적으로. 벨로컴퍼니가 실행한 플랫폼마다 사장님 매출이 달라졌습니다.</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-10">
          <div className="flex lg:flex-col gap-2 overflow-x-auto lg:overflow-visible pb-2 lg:pb-0 shrink-0">
            {PLATFORM_DATA.map((item, index) => (
              <button
                ...
                className={`shrink-0 px-4 py-3 rounded-xl text-left text-sm font-medium transition-all whitespace-nowrap flex items-center gap-2 ${
                  activeIndex === index ? "border-l-4 rounded-l-none" : "bg-white/5 border border-transparent hover:bg-white/10"
                }`}
                style={activeIndex === index ? { borderLeftColor: ACCENT, backgroundColor: "rgba(255,214,0,0.12)", color: "#fff" } : {}}
              >
          ...
          <div className="flex-1 min-w-0 flex flex-col xl:flex-row gap-8" ref={contentInView.ref}>
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="flex-1 min-w-0 flex flex-col xl:flex-row gap-8"
              >
                {/* 목업 카드 영역 */}
                <div className="flex-1 min-w-0">
                  {active.id === "naver" && (
                    <div className="bg-white rounded-[20px] overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
                      <div className="h-8 flex items-center px-4 text-white text-sm font-bold" style={{ backgroundColor: NAVER_GREEN }}>NAVER 플레이스</div>
                      ...
                      <div className="p-4">
                        ...
                        <p className="text-sm text-gray-600 mt-0.5">★★★★★ <span className="text-yellow-500">4.9</span> (리뷰 1,247개)</p>
                        <div className="border-t border-gray-200 my-3" />
                        <div className="grid grid-cols-3 gap-4 text-center">
                          <div><p className="text-xs text-gray-500">월 클릭</p><p className="font-bold text-black">4,100회</p></div>
                          <div><p className="text-xs text-gray-500">전화문의</p><p className="font-bold text-black">94건</p></div>
                          <div><p className="text-xs text-gray-500">길찾기</p><p className="font-bold text-black">1,832회</p></div>
                        </div>
                      </div>
                      <div className="bg-gray-100 p-3 space-y-3">
                        <div className="flex gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-black text-sm">체형교정 후 확실히 달라졌어요. 원장님이 꼼꼼하게...</p>
                        ...
                        <div className="flex gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-black text-sm">추나요법 받고 허리 통증이 많이 나았어요. 강추합니다!</p>
                            <p className="text-yellow-500 text-xs">★★★★★</p>
                          </div>
                        </div>
                      </div>
                  ...
                  {active.id === "danggeun" && (
                    <div className="bg-white rounded-[20px] overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
                      <div className="h-8 flex items-center px-4 text-white text-sm font-bold" style={{ backgroundColor: DANGGEUN_ORANGE }}>🥕 당근마켓</div>
                      <div className="p-4">
                  ...
                  {active.id === "insta" && (
                    <div className="flex flex-col sm:flex-row gap-6 items-start">
                      <div className="bg-black rounded-[30px] p-2 shadow-xl shrink-0 mx-auto sm:mx-0" style={{ width: 220, height: 440 }}>
                        <div className="h-6 flex items-center justify-center gap-1">
                          <div className="w-3 h-3 rounded-full bg-gray-700" />
                          <div className="w-8 h-4 rounded-full bg-gray-800" />
                        </div>
                        <div className="relative w-full flex-1 rounded-2xl overflow-hidden mt-2" style={{ height: "calc(100% - 52px)" }}>
                          <ImgFallback src={IMAGE_URLS.food} alt="" fill className="object-cover" />
                      ...
                      <div className="flex-1 min-w-0 rounded-xl bg-gray-800/60 border border-gray-700 p-4">
                        <p className="text-slate-400 text-sm mb-2">게시 후 72시간</p>
                        <p className="text-2xl font-bold text-white mb-2">조회수 <span style={{ color: RESULT_GREEN }}>127만</span></p>
                  ...
                  {active.id === "xiaohongshu" && (
                    <div className="bg-white rounded-[20px] overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
                      <div className="h-8 flex items-center px-4 text-white text-sm font-bold" style={{ backgroundColor: XIAOHONGSHU_RED }}>小红书 샤오홍슈</div>
                      ...
                      <div className="p-4">
                        <p className="text-black font-medium">韓國必去！강남 피부과 솔직 후기 ✨</p>
                        <div className="flex gap-4 mt-2 text-sm text-gray-600">♥ 2.4万 &nbsp; ⭐수집 1.1万 &nbsp; 💬 847</div>
                      </div>
                      <div className="px-4 pb-4">
                  ...
                  {active.id === "baemin" && (
                    <div className="bg-white rounded-[20px] overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
                      <div className="h-8 flex items-center px-4 text-white text-sm font-bold" style={{ backgroundColor: BAEMIN_MINT }}>배달의민족</div>
                      ...
                      <div className="p-4">
                        <h3 className="text-black font-bold text-lg">○○ 치킨</h3>
                        <p className="text-sm text-gray-600">★★★★★ 4.9 / 리뷰 3,420개 · 배달 20-30분</p>
                        <div className="flex gap-3 mt-3">
                          <div className="flex gap-2 flex-1 min-w-0">
                            <div className="relative w-14 h-14 rounded-lg overflow-hidden shrink-0">
                              <ImgFallback src={IMAGE_URLS.food} alt="" fill className="object-cover" />
                            </div>
                            <div className="min-w-0"><p className="text-black text-sm font-medium truncate">후라이드</p><p className="text-gray-600 text-xs">18,000원</p></div>
                          </div>
                          <div className="flex gap-2 flex-1 min-w-0">
                            <div className="relative w-14 h-14 rounded-lg overflow-hidden shrink-0">
                              <ImgFallback src={IMAGE_URLS.food} alt="" fill className="object-cover" />
                            </div>
                            <div className="min-w-0"><p className="text-black text-sm font-medium truncate">반반 set</p><p className="text-gray-600 text-xs">22,000원</p></div>
                          </div>
                        </div>
                        <div className="border-t border-gray-200 mt-3 pt-3 flex gap-4 text-sm">
                  ...
                  <div className="pt-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {active.tags.slice(0, 6).map((tag, i) => (
                        <span key={i} className="px-2 py-1 rounded-full border border-white/30 text-slate-300 text-xs">{tag}</span>
                      ))}
                    </div>
                    <p className="text-slate-500 text-xs mt-3">벨로컴퍼니가 직접 기획·실행합니다. 외주 없음.</p>
                  </div>
                </div>
              </motion.div>
            </AnimatePresence>
        ...
        {/* 타임라인 */}
        <div className="mt-20 sm:mt-24 pt-12 sm:pt-16 border-t border-white/10 rounded-2xl px-4 sm:px-6 py-10" style={{ backgroundColor: BG_LIGHT }}>
          <h3 className="text-center text-xl font-bold text-white mb-2">계약 후 4주, 실제로 이렇게 달라집니다</h3>
          <p className="text-center text-slate-500 text-sm mb-10">벨로컴퍼니 진행 사례 평균 데이터</p>
          <div className="flex flex-col md:flex-row md:items-stretch gap-6 md:gap-4 overflow-x-auto pb-4">
            {TIMELINE.map((step, i) => (
              <motion.div
                key={step.week}
                ...
                className="relative flex flex-col shrink-0 md:flex-1"
              >
                {i > 0 && (
                ...
                <div className="rounded-xl border border-white/20 bg-gray-900/50 p-5 h-full flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold text-black shrink-0" style={{ backgroundColor: step.iconBg === "transparent" ? RESULT_GREEN : step.iconBg }}>{"weekNum" in step ? (step as { weekNum?: string }).weekNum : step.week.replace(/[^\d]/g, "") || "∞"}</span>
                  ...
                  <ul className="space-y-2 mb-4 flex-1">
                    {step.items.map((item, j) => (
                      <li key={j} className="text-slate-400 text-sm flex items-center gap-2">✅ {item}</li>
                    ))}
                  </ul>
